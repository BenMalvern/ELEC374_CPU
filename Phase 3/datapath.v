...
(
	...
	wire [15:0] Rin_sel;
	wire [15:0] RoutA_sel, RoutB_sel, RoutC_sel;
	...
	// Bus C control vector
	wire [23:0] bus_control_C;
	assign bus_control_C[15:0] = RoutC_sel;
	assign bus_control_C[16]   = HIoutC;
	assign bus_control_C[17]   = LOoutC;
	assign bus_control_C[18]   = ZhighoutC;
	assign bus_control_C[19]   = ZlowoutC;
	assign bus_control_C[20]   = PCoutC;
	assign bus_control_C[21]   = MDRoutC;
	assign bus_control_C[22]   = InPortoutC;
	assign bus_control_C[23]   = CoutC;
    ...
    .BusIn19(Z_LO_Q),
    .BusIn20(PC_Q),
    .BusIn21(BusMuxIn_MDR),   // or MDR_Q if that is your intended registered MDR output
    .BusIn22(InPort_Q),
    .BusIn23(C_sign_extended)
);
